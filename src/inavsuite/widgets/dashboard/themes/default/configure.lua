...
local function getPref(key) return inavsuite.widgets.dashboard.getPreference(key) end

local function setPref(key, value) inavsuite.widgets.dashboard.savePreference(key, value) end

local formFields = {}
local prevConnectedState = nil

local function isTelemetryConnected() return inavsuite and inavsuite.session and inavsuite.session.isConnected and inavsuite.session.mcu_id and inavsuite.preferences end
