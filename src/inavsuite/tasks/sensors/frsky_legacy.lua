    ...
    if createSensorList[appId] ~= nil then
        ...
        if frsky_legacy.createSensorCache[appId] == nil then
            ...
            if frsky_legacy.createSensorCache[appId] == nil then
                ...
                frsky_legacy.createSensorCache[appId]:module(inavsuite.session.telemetrySensor:module())
...
function frsky_legacy.wakeup()
    ...
    if inavsuite.tasks and inavsuite.tasks.telemetry and inavsuite.session.telemetryState and inavsuite.session.telemetrySensor then if inavsuite.app.guiIsRunning == false and inavsuite.tasks.msp.mspQueue:isProcessed() then while telemetryPop() do end end end
